...
PROMPT_V1_NAME = "dongocbich-day22-rag-prompt-v1"
PROMPT_V2_NAME = "dongocbich-day22-rag-prompt-v2"
...
def push_prompts_to_hub(client: Client):
    ...
    try:
        url = client.push_prompt(PROMPT_V1_NAME, object=PROMPT_V1, description="V1 - ngan gon, than thien")
    ...
    try:
        url = client.push_prompt(PROMPT_V2_NAME, object=PROMPT_V2, description="V2 - chuyen nghiep, co cau truc")
